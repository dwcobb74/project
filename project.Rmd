...
1)  Turbos might matter
2)  A short list of Make Models show up with significant P-Values, suggesting there are differences between make and models in terms of fatal outcomes
3)  Other factors included don't suggest there a relationship to the target variable
4)  Need to go another layer deeper into the data
